...
To avoid repeating the same setup across vignettes, we can extract the **common** setup out into a script (`vignettes/setup/setup.R`), and source it from vignettes.
