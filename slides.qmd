...
What if you can't store reusable documentation in child documents and still wish to not repeat yourself? 

You can use the same stratagem as before!
...
You can name these folders however you wish, but it is advisable for names to suggest their contents (e.g., `r-examples`, `yaml-snippets`, etc.).

:::

## Using non-child documents in package {.smaller}

You can now insert contents of these documents in the package documentation anywhere and as many as times as you want.
...
```{r, child = "../man/md-fragments/info1.Rmd"}
```
