...
![](media/simpsons.png){.absolute width="800" height="400" left="70" top="155"}

::: {style="text-align: center; font-size: 0.7em; margin-top: 2em; color: #666;"}
Source code for these slides can be found [on GitHub](https://github.com/IndrajeetPatil/second-hardest-cs-thing/).
:::
...
&nbsp; &nbsp; {{< fa regular file size=5x >}} &nbsp; &nbsp; {{< fa regular plus size=5x >}} &nbsp; &nbsp; {{< fa regular file-lines size=5x >}} &nbsp;&nbsp; {{< fa solid equals size=5x >}} &nbsp;&nbsp; {{< fa solid file-lines size=5x >}}
